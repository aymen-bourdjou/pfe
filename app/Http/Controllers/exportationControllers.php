...
{public function export($id_inventaire)
    {
        ...
        $data = 'Nom inventaire' . $Sp . 'Etat inventaire' . $Sp . 'Date creation inventaire' . $Sp . 'Date debut inventaire' . $Sp . 'Date fin inventaire' . $Sp . 'Nom employe createur' . $Sp . 'Nom employe updateur' . $Sp . 'Date mise a jour inventaire' . $Sp . 'observation' . $Rt;
        ...
        if ($comptages) {
            foreach ($comptages as $comptage) {
                $data .= 'Nom comptage' . $Sp . 'Etat comptage' . $Sp . 'Date creation comptage' . $Sp . 'Date debut comptage' . $Sp . 'Date fin comptage' . $Sp . 'Nom employe createur' . $Sp . 'Nom employe updateur' . $Sp . 'Date mise a jour comptage' . $Sp . 'observation' . $Rt;
                ...
                $data .= $Core . $Rt;
                $data .= 'CODE' . $Sp . 'LIBELLE' . $Sp . 'Date' . $Sp . 'Prix' . $Sp . 'Affectation' . $Sp . 'bil' . $Sp . 'NO_SERIE ' . $Sp . 'EMPLACEMENT' . $Sp . 'etas' . $Sp . 'vie' . $Sp . 'zone' . $Sp . 'etat d\'inventaire' . $Sp . 'Agent' . $Sp . 'date d\'inventaire' . $Rt;
    
                $comptage_biens = comptage_bien::where('id_comptage', $comptage->id_comptage)->get();
                if ($comptage_biens) {
