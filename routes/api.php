    ...
    */ 
    ...
    //Route::get('comptage/export/{id_comptage}', [exportationControllers::class, 'exportcomptage']);
     Route::get('inventaire/export/{id_inventaire}', [exportationControllers::class, 'export']);
        ...
        Route::get('/afiicher_inventaire_speciale/{id_user}', [inventaireControllers::class, 'showspeciale']);
    ...
    Route::prefix('equipe')->group(function () {
        ...
        Route::get('/afiicher_equipe_par_user/{id_user}', [equipeControllers::class, 'showparuser']);
    ...
    Route::prefix('equipe-user')->group(function () {
        ...
        Route::get('/afiicher_list_non_user/{id_equipe}', [equipe_userControllers::class, 'showparnonequipe']);
        Route::get('/afiicher_list_user/{id_equipe}', [equipe_userControllers::class, 'showparequipe']);
    ...
    Route::prefix('departement')->group(function () {
        ...
        Route::get('/afiicher_departement_par_zone/{id_zone}', [departementControllers::class, 'show_par_zone']);
    ...
    Route::prefix('comptage')->group(function () {
        ...
        Route::get('/afiicher_comptage_par_inventaire_user/{id_inventaire}/{id_user}', [comptageControllers::class, 'showparidinventaireetuser']);
        Route::get('/afiicher_comptage_par_inventaire/{id_inventaire}', [comptageControllers::class, 'showparidinventaire']);
    ...
    Route::prefix('comptage-bien')->group(function () {
        ...
        Route::get('/afiicher_comptage_bien_par_comptage/{id_comptage}', [comptage_bienControllers::class, 'showparcomptage']);
    ...
    Route::prefix('role')->group(function () {
        ...
        Route::get('/afiicher_role_actife', [roleControllers::class, 'show_etas']);
    ...
    Route::prefix('user')->group(function () {
        ...
        Route::get('/liste_user2', [userControllers::class, 'index2']);
    ...
    Route::prefix('role-permission')->group(function () {
        ...
        Route::get('/afiicher_list_permission/{id_role}', [role_permissionControllers::class, 'showparrole']);
        Route::get('/afiicher_list_non_permission/{id_role}', [role_permissionControllers::class, 'showparnonrole']);
